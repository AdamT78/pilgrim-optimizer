...
| Confession Box | yes (round-end only) | own / market / opponent | temporary start-player piety bonus | fixed `+2` | applies only while determining deciding player; no real piety change |
