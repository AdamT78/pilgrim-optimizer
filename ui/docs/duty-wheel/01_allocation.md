...
Monks moving in procession between an abbey cloister and a workshop range, a robed official directing them with a raised hand.
...
Hooded monks driven across a rain-soaked cloister yard in single file, heads down, a tall official with a ledger counting them off as they pass.
...
```
python3 check_tile.py 01_allocation_A.png --version A  --single
```
