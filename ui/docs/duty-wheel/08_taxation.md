...
A steward at a table with a tally stick and coin scales, villagers queuing to pay, a clerk writing.
...
A steward with ledger and strongbox, a soldier at his shoulder, a woman laying down her last coin while a child watches from her skirts.
...
```
python3 check_tile.py 08_taxation_A.png --version A  --single
```
