...
Two actions: **Produce wheat** on the left, **Produce stone** on the right.

## Version A — engraved plate

Save as **`07_produce_A.png`**
...
Left (Produce wheat): Peasants reaping wheat with sickles, sheaves stood behind them.
Right (Produce stone): Quarrymen splitting a block with wedges, a laden sledge behind.
...
Two scenes side by side, each occupying exactly half of a square frame.
Left (Produce wheat): Reapers bent in a thin wind-flattened field under a low black sky, one doubled over.
Right (Produce stone): Quarrymen splitting rock at the foot of a pit, dust in the air, a broken sledge beside them.
...
```
python3 check_tile.py 07_produce_A.png --version A
```
