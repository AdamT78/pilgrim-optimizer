"""Write the generated hex map debug page from the structured layout.
...
def generate_map_page(
    *,
    ...
    layout = load_map_layout(layout_path)
    destination.parent.mkdir(parents=True, exist_ok=True)
    destination.write_text(render_map_html(layout), encoding="utf-8")
    return destination


def main() -> None:
    written = generate_map_page()
